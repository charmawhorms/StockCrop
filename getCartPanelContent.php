<?php
// === DEBUGGING AND SESSION SETUP ===
// ini_set('display_errors', 1); // Uncomment these for deeper debugging if needed
...
if (isset($_SESSION['id'])) {
    ...
    // 🌟 FIX: p.imagePath added to the SELECT list to display images
...
$response['itemsHtml'] = ob_get_clean(); // Capture items HTML
