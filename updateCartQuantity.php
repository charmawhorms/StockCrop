...
if (isset($_SESSION['id'])) {
    ...
    // Step A: Get the cartId for the user
    ...
    if (!$cartId) {
        ...
        // Step B: REMOVE item from cartItems table
        ...
        // Step C: UPDATE quantity in cartItems table
        
        // Safety check (optional but recommended): Check against stockQuantity here if desired
    ...
    // 2. Guest User (Updating the Session Cart)
