...
<body>
    ...
    <section class="shop-hero text-center text-white d-flex align-items-center justify-content-center">
        <div class="container">
            <h1 class="display-5 fw-bold">Shop Fresh. Eat Local.</h1>
            <p class="lead">Explore authentic Jamaican produce directly from our farmers — fresh, local, and delivered to your door.</p>
            <a href="#products" class="btn btn-light mt-3">Browse Products</a>
        </div>
    </section>
